simFunUn <- function(n=100, d=10, k=NULL, tau=.5, dtau=0, distribution="normal", num_sim = 250, filename = "res", clus = NULL){
  ...
  source("functions/testEquiRankUn.R")
  clusterExport(clus, varlist=c("sim.grid",
                                "computeTh","buildSigma",
                                "generateData", "testEquiRankUn"),envir = environment())
