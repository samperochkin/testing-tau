...
saveRDS(Tau.hat,"Th.rds")
saveRDS(Tau.tilde,"Tt.rds")
saveRDS(B,"B.rds")
saveRDS(clus,"clus.rds")
saveRDS(ij.mat,"ijmat.rds")
...
# pdf("figures/blocks-app.pdf", width = 3, height = 3)
pdf("figures/Tt-app.pdf", width = 3, height = 3)
par(mar=rep(0,4))
image(t(Tau.tilde[d:1,]), zlim=c(-1,2), col = pal, xaxt="n", yaxt="n")
