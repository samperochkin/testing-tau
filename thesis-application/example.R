...
# # pdf(width = 5, height = 5, file = "TauY-2-annot.pdf")
# par(mar=c(0,0,0,0))
# image(t(Tau[ncol(Tau):1,]), col = cols, zlim = c(-1,2), axes = F)
# text(x = 14.5/18, y = 13.5/18, labels = expression("G"["(0)"]), cex = 2)
# 
# text(x = 3/18, y = 17.5/18, labels = expression("G"["(0,1)"]^"(1,2)"), cex = 1.5)
# text(x = 7.25/18, y = 17.5/18, labels = expression("G"["(0,1)"]^"(1,3)"), cex = 1.5)
# text(x = 7.25/18, y = 14.75/18, labels = expression("G"["(0,1)"]^"(2,3)"), cex = 1.5)
# 
# text(x = 8.75/18, y = 11.85/18, labels = expression("G"["(0,1,3)"]), cex = 1.5)
# 
# text(x = 17/18, y = 5.5/18, labels = expression("G"["(0,2)"]), cex = 1.5)
# # dev.off()
