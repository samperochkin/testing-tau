...
Estimated rejection rates of tests of $H_0^*$ with $\\mathcal{G}=\\{\\{1,\\ldots,d\\}\\}$ performed at nominal level $5$\\%. Each entry is based on $",M,"$ $n \\times d$ datasets drawn from a ",distribution_text," with Kendall's tau matrix $\\bs{T}_{\\Delta}$ in Eq.~\\eqref{eq:departure} (i) with $\\Delta = ",dtau,"$; $\\bs{T}$ is as in Eq.~\\eqref{eq:T-equi-null}.}      \\label{tab:sim-power-",dtau_id,"-Star-", distribution,"}
      \\begin{center}
      \\fontsize{8.75}{8.75}\\selectfont
      \\vskip-12pt
      \\begin{tabular}{*{2}{l}*{12}{r}}
      \\toprule
      \\multicolumn{14}{c}{$E_{np}$ with $\\SA = \\Sh_{np}$ for ",dtau_type," departures ($\\Delta = ",dtau,"$)}\\\\
      \\midrule
      ...
      & 100 && ", rowPart(), "\\\\
      \\midrule
      \\multicolumn{14}{c}{$E_{np}$ with $\\SA = (1/n)\\I_p$ for ",dtau_type," departures ($\\Delta = ",dtau,"$)}\\\\
      \\midrule
      \\multicolumn{2}{c}{} & & \\multicolumn{3}{c}{$\\tau = 0$} & & \\multicolumn{3}{c}{$\\tau = 0.3$} & & \\multicolumn{3}{c}{$\\tau = 0.6$}\\\\
      \\cmidrule(lr){4-6}  \\cmidrule(lr){8-10}  \\cmidrule(lr){12-14}
      $\\Sh_{np}$ & $d$\\big|$n$ & & 50 & 100 & 150 & & 50 & 100 & 150 & & 50 & 100 & 150 \\\\
      ...
      & 100 && ", rowPart(), "\\\\
      \\midrule
      \\multicolumn{14}{c}{$M_{np}$ with $\\SA = (1/n)\\I_p$ for ",dtau_type," departures ($\\Delta = ",dtau,"$)}\\\\
      \\midrule
      \\multicolumn{2}{c}{} & & \\multicolumn{3}{c}{$\\tau = 0$} & & \\multicolumn{3}{c}{$\\tau = 0.3$} & & \\multicolumn{3}{c}{$\\tau = 0.6$}\\\\
      \\cmidrule(lr){4-6}  \\cmidrule(lr){8-10}  \\cmidrule(lr){12-14}
      $\\Sh_{np}$ & $d$\\big|$n$ & & 50 & 100 & 150 & & 50 & 100 & 150 & & 50 & 100 & 150 \\\\
