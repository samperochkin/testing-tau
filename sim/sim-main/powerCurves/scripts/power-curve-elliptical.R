...
if(!file.exists(paste0("sim/sim-main/powerCurves/pre-computed/elliptical/sigma_list_",run.id,".rds"))){
  ...
  saveRDS(sigma.list, paste0("sim/sim-main/powerCurves/pre-computed/elliptical/sigma_list_",run.id,".rds"))
}else{
  sigma.list <- readRDS(paste0("sim/sim-main/powerCurves/pre-computed/elliptical/sigma_list_",run.id,".rds"))
}
...
S.star <- function(d, S2, S){
  p <- choose(d,2)
  B <- matrix(1,p,1)
  
  S2 <- Sigma.list[[d_id]]$Sigma2
...
if(!file.exists(paste0("sim/sim-main/powerCurves/pre-computed/elliptical/zeta1_list_",run.id,".rds"))){
  ...
  saveRDS(zeta1.list, paste0("sim/sim-main/powerCurves/pre-computed/elliptical/zeta1_list_",run.id,".rds"))
  
}else{
  zeta1.list <- readRDS(paste0("sim/sim-main/powerCurves/pre-computed/elliptical/zeta1_list_",run.id,".rds"))
}
